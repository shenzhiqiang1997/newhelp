...
CREATE TABLE teacher_(
	...
	authority TINYINT UNSIGNED COMMENT '教师权限',
...
CREATE TABLE base_student_(
	...
	photo_url VARCHAR(50) COMMENT '学生照片url',
	duty VARCHAR(20) COMMENT '学生职务',
	dormitory VARCHAR(15) COMMENT '学生宿舍',
	...
	major VARCHAR(10) COMMENT '学生专业',
	political_status VARCHAR(6) COMMENT '学生政治面貌',
	ethnic_group VARCHAR(5) COMMENT '学生民族',
	birth_origin VARCHAR(10) COMMENT '学生籍贯',
	college_entrance_exam_score VARCHAR(7) COMMENT '学生高考成绩/满分',
	college_entrance_exam_english_score VARCHAR(7) COMMENT '学生高考英语成绩/满分',
	entrance_exam_english_score TINYINT UNSIGNED COMMENT '学生英语入校考试成绩',
	hometown_railway_station VARCHAR(10) COMMENT '学生家乡所在火车站',
	province VARCHAR(10) COMMENT '学生省份',
	city VARCHAR(12) COMMENT '学生所在城市',
	family_address VARCHAR(30) COMMENT '学生家庭详细地址',
	family_tel_number VARCHAR(14) COMMENT '学生家庭电话',
	postcode VARCHAR(6) COMMENT '学生邮政编码',
	specialty VARCHAR(20) COMMENT '学生特长',
	duty_in_high_school VARCHAR(20) COMMENT '学生高中曾任职务',
	award_in_high_school VARCHAR(30) COMMENT '学生高中曾获奖励',
	is_had_technology_competition_award VARCHAR(50) COMMENT '学生是否有科技竞赛类获奖',
	father_name VARCHAR(12) COMMENT '学生父亲姓名',
	father_work_unit VARCHAR(20) COMMENT '学生父亲工作单位',
	father_work_unit_address VARCHAR(30) COMMENT '学生父亲工作单位详细地址',
	father_duty VARCHAR(20) COMMENT '学生父亲职务',
	father_postcode VARCHAR(6) COMMENT '学生父亲邮编',
	father_tel_number VARCHAR(14) COMMENT '学生父亲电话',
	mother_name VARCHAR(12) COMMENT '学生母亲姓名',
	mother_work_unit VARCHAR(20) COMMENT '学生母亲工作单位',
	mother_work_unit_address VARCHAR(30) COMMENT '学生母亲工作单位详细地址',
	mother_duty VARCHAR(20) COMMENT '学生母亲职务',
	mother_postcode VARCHAR(6) COMMENT '学生母亲邮编',
	mother_tel_number VARCHAR(14) COMMENT '学生母亲电话',
...
CREATE TABLE expose_setting_(
	...
	expose_award_in_high_school TINYINT UNSIGEND DEFAULT 0 COMMENT '是否暴露学生高中曾获奖励',
