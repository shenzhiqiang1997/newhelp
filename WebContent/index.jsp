...
<div class="infoHolder">
	...
	<form action="<%=path%>/backend/login" method="post">
	    <input id="userName" name="teacherId" placeholder="用户名"/>
	    <span id="enterInfo" class="warningMsg"></span><br/>
	    <input id="passWords" name="password" type="password" placeholder="密码" />
...
<!-- 如果作为管理员登录过 那么直接重定向到列表 -->
<c:if test="${!empty sessionScope.user }">
	<script type="text/javascript">
		window.location.href="<%=path%>/backend/teachers";
	</script>
</c:if>
</body>
</html>